...
Run from project root:
    python -m ml.pipelines.evaluation.evaluate

Outputs metrics and plots into ml/pipelines/evaluation/results/.
"""
...
DATA_CONFIG = {
    "diabetes": {
        ...
        "model": "ml/models/diabetes_xgboost.pkl",
        "features": None,
        "scaler": None,
        "calibrator": "ml/models/isotonic_calibrator.pkl",
    ...
    "heart_disease": {
        ...
        "model": "ml/models/heart_disease_xgboost.pkl",
        "features": "ml/models/heart_disease_features.pkl",
        "scaler": None,
        "calibrator": "ml/models/heart_disease_calibrator.pkl",
    ...
    "lung_cancer": {
        ...
        "model": "ml/models/lung_cancer_model.pkl",
        "features": "ml/models/lung_cancer_features.pkl",
        "scaler": "ml/models/lung_cancer_scaler.pkl",
        "calibrator": "ml/models/lung_cancer_calibrator.pkl",
        "decision_threshold": 0.5,
        "target_names": ["No Risk", "At Risk"],
    },
}

RESULTS_DIR = "ml/pipelines/evaluation/results"
