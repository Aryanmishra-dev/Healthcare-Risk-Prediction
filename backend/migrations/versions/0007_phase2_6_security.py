...
def upgrade() -> None:
    ...
    op.add_column('user_sessions', sa.Column('login_method', sa.String(length=50), server_default='password', nullable=False))
    op.add_column('user_sessions', sa.Column('last_activity', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
