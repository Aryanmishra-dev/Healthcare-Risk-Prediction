...
def upgrade() -> None:
    ...
    op.add_column('prediction_audit_logs', sa.Column('model_version_id', sa.Uuid(), nullable=True))
    op.add_column('prediction_audit_logs', sa.Column('is_calibrated', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('prediction_audit_logs', sa.Column('ab_test_group', sa.String(length=50), nullable=True))
    op.add_column('prediction_audit_logs', sa.Column('drift_detected', sa.Boolean(), server_default='0', nullable=False))
