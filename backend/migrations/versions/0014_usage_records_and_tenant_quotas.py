...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_usage_records_tenant_id"),
        "usage_records",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_usage_records_recorded_at"),
        "usage_records",
        ["recorded_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tenant_quotas_id"), "tenant_quotas", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_tenant_quotas_tenant_id"),
        "tenant_quotas",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_tenant_quotas_tenant_id"), table_name="tenant_quotas"
    )
    op.drop_index(op.f("ix_tenant_quotas_id"), table_name="tenant_quotas")
    op.drop_table("tenant_quotas")
    op.drop_index(
        op.f("ix_usage_records_recorded_at"), table_name="usage_records"
    )
    op.drop_index(
        op.f("ix_usage_records_api_key_id"), table_name="usage_records"
    )
    op.drop_index(
        op.f("ix_usage_records_tenant_id"), table_name="usage_records"
    )
