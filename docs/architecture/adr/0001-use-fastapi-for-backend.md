...
- **Mitigation:** We will maintain clear patterns in `backend/app/main.py` and `backend/app/db/session.py` and rely on dependency injection for db sessions and API keys.
