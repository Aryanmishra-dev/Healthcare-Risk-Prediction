...
- **Mitigation:** We logically separate API schema boundaries (`/predict/...`) returning HTML partials in standard template directories, keeping `app/main.py` highly organized.
