...
DATA_PATH = os.path.join(ROOT, "survey_lung_cancer.csv")
MODEL_DIR = os.path.join(ROOT, "models")
PLOT_DIR = os.path.join(ROOT, "notebooks", "lung_cancer_plots")
...
print("=" * 70)
print(f"Dataset:            survey_lung_cancer.csv")
...
print(f"Saved artifacts:    model, scaler, features → models/")
