...
class TestModelRegistry:
    ...
    def test_registry_verify_script(self):
        ...
        if os.path.exists(model_path) and os.path.getsize(model_path) < 1024:
            pytest.skip("Using stub models; hashes will intentionally mismatch the registry")
...
class TestProductionReadiness:
    ...
    def test_nginx_config_exists(self):
        ...
        assert os.path.isfile(nginx_conf), "deployment/nginx/nginx.conf not found"
    ...
    def test_nginx_dev_config_exists(self):
        ...
        assert os.path.isfile(nginx_conf), "deployment/nginx/nginx.dev.conf not found"
